 ...
 * Use the {@link ImageListingFragment#newInstance} factory method to
...
public class ImageListingFragment extends Fragment {
    ...
    public static ImageListingFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_image_listing, container, false);
    }
}